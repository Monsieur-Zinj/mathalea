...
<label for={dialogId} class="{classForButton}  hover:cursor-pointer">
  <div class="tooltip tooltip-bottom tooltip-neutral" data-tip={tooltipMessage}>
    ...
    {#if buttonSecondIcon.length !== 0}
      <i
        class="absolute -bottom-1 bg-coopmaths-canvas dark:bg-coopmathsdark-canvas rounded-full bx {buttonSecondIcon} text-sm -translate-x-3 text-coopmaths-warn dark:text-coopmathsdark-warn"
      />
    {/if}
  </div>
</label>
...
<div class="modal">
  <div
    class="modal-box relative z-0 bg-coopmaths-canvas dark:bg-coopmathsdark-canvas-dark"
  >
    <dialog
      class="rounded-xl z-10 bg-coopmaths-canvas text-coopmaths-corpus dark:bg-coopmathsdark-canvas-dark dark:text-coopmathsdark-corpus-light"
      id="{dialogId}-1"
    >
    ...
    <h3
      class="text-lg font-bold text-coopmaths-struct dark:text-coopmathsdark-struct"
    >
      QR-Code du Diaporama
    </h3>
    <p
      class="py-4 text-base font-light text-coopmaths-corpus dark:text-coopmathsdark-corpus"
    >
    ...
    <div class="flex flex-row items-center justify-start">
      <div
        class="font-semibold text-coopmaths-struct-light dark:text-coopmathsdark-struct-light"
      >
        Format de l'image
      </div>
      <FormRadio
