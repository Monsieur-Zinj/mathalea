<script lang="ts">
  ...
  let isInteractif: boolean = exercice.interactif && exercice?.interactifReady !== undefined && exercice?.interactifReady

  const title = exercice.id
    ? `${exercice.id.replace('.js', '')} - ${exercice.titre}`
    : exercice.titre
    ...
    if (mathalea2dFigures.length !== 0) {
      ...
      for (let k = 0; k < mathalea2dFigures.length; k++) {
        ...
        if (mathalea2dFigures[k].clientWidth > body.clientWidth) {
          const coef =
            (body.clientWidth * 0.9) / mathalea2dFigures[k].clientWidth
...
<div class="z-0 flex-1 w-full mb-10 lg:mb-20" bind:this={divExercice}>
  ...
  <div class="flex flex-col-reverse lg:flex-row">
    ...
    >
      <div
        class="flex flex-row justify-start items-center {indiceLastExercice >
          1 && $globalOptions.presMode !== 'un_exo_par_page'
          ? 'ml-2 lg:ml-6'
          : 'ml-2'} mb-2 lg:mb-6"
      >
        <div
        ...
        <div
          ...
          !exercice.isDone &&
          ((exercice.interactif && exercice.isDone) || !exercice.interactif)
            ? 'flex ml-2'
            : 'hidden'}
        >
          <Button
            title={isCorrectionVisible
        ...
        <button
          class={$globalOptions.isInteractiveFree && exercice?.interactifReady
          ...
          >
            {#each exercice.listeQuestions as item, i (i)}
              <div
                ...
                class="container grid grid-cols-1 auto-cols-min gap-4 mb-2 lg:mb-4"
              >
                <li
