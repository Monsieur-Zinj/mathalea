<a
  ...
  target="_blank"
  class="flex flex-col items-center mx-auto max-w-md p-3 rounded-lg shadow
...
>
  ...
  <p class="text-center font-normal text-gray-700 dark:text-gray-400">
    Découvrez les cahiers de vacances pour préparer la rentrée en seconde ou en première spécialité.
  </p>
</a>
