<script lang="ts">
  ...
  const referentiels = ($globalOptions.interfaceBeta) ? [exercisesReferentielForSideMenu, staticReferentielForSideMenu, appTierceReferentielForSideMenu, ressourcesReferentielForSideMenu] : [exercisesReferentielForSideMenu, staticReferentielForSideMenu, appTierceReferentielForSideMenu, ressourcesReferentielForSideMenu]
</script>
