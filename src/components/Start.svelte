...
<div class="scrollbar-hide h-screen {$darkMode.isActive ? 'dark' : ''} bg-coopmaths-canvas dark:bg-coopmathsdark-canvas" id="startComponent">
  ...
  <div class="flex flex-col h-[calc(100vh-7rem)] bg-coopmaths-canvas dark:bg-coopmathsdark-canvas mt-6 lg:mt-0">
    <main
      class="ml-0 lg:ml-4 flex flex-col lg:flex-row h-[calc(100vh-7rem)] bg-coopmaths-canvas dark:bg-coopmathsdark-canvas text-coopmaths-corpus dark:text-coopmathsdark-corpus"
    ...
    >
      ...
      <!-- Version du menu pour breakpoint >= LG -->
      <div class="hidden lg:flex h-[calc(100vh-7rem)]">
      ...
      <div class="w-full">
        ...
        {:else}
          <div class="relative flex flex-col h-[calc(100vh-7em)] justify-start text-coopmaths-corpus dark:text-coopmathsdark-corpus lg:px-10 py-6 lg:py-40">
            <div class="animate-pulse h-full flex flex-col lg:flex-row justify-start space-x-6 items-center">
              <div class="mt-[10px]">
                <div class="hidden lg:inline-flex"><i class="bx bx-chevron-left text-[50px]" /></div>
                <div class="inline-flex lg:hidden"><i class="bx bx-chevron-up text-[50px]" /></div>
              </div>
