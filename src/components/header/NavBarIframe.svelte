<nav class="p-4 bg-coopmaths-canvas dark:bg-coopmathsdark-canvas">
  ...
  <div class="flex flex-row justify-between items-start w-full mx-auto md:space-x-6">
    <div class="flex flex-col md:flex-row justify-start md:items-end space-x-0 md:space-x-2">
      <!-- logo -->
      <div class=" inline-flex text-5xl md:text-4xl font-logo9 tracking-tighter font-black text-coopmaths-struct dark:text-coopmathsdark-struct">MathALÉA</div>
      <div class="font-light text-sm text-coopmaths-corpus-lightest dark:text-coopmathsdark-corpus-lightest">
