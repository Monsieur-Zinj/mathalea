    ...
    <div class="hidden md:flex">
      ...
      >
        ...
        >
          ...
          >
            <i
              class="bx bx-right-arrow-alt text-2xl text-coopmaths-action dark:text-coopmathsdark-action hover:text-coopmaths-action-lightest hover:dark:text-coopmathsdark-action-lightest"
            />
          </button>
        </div>
