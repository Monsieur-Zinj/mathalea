  ...
  constructor () {
    ...
    const updateVideoSize = () => {
      if (window.innerWidth > window.innerHeight) {
        ...
        this.iframe.setAttribute('height', (this.iframe.offsetWidth * 0.75).toString())
      } else {
        this.iframe.setAttribute('width', '100%')
        this.iframe.setAttribute('height', (this.iframe.offsetWidth * 1.5).toString())
      }
    }
    const initExercice = () => {
    ...
    this.container.addEventListener('transitionend', updateVideoSize)
