...
class PolynesieJuin2024Ex2Q1 extends Exercice {
  ...
  nouvelleVersion (): void {
    ...
    this.autoCorrection[0].propositions = [
      ...
      {
        texte: '$f(x) = - \\dfrac43 e^{-3x} + \\dfrac73$',
        statut: true
      },
      {
        texte: '$f(x) = e^{-3x} + \\dfrac73$',
        statut: false
      },
      {
        texte: '$f(x) = - \\dfrac{10}{3} e^{-3x} - \\dfrac73$',
        statut: false
      }
    ]
    ...
    const texteCorr = `${monQcm.texteCorr}<br>L'équation différentielle $y' = - 3y$ a pour solutions les fonctions $x \\longmapsto f(x) = K e^{- 3x}$, avec $K \\in \\R$.<br>
    ...
    On sait qu'alors les solutions de l'équation différentielle $y' = - 3y + 7$ sont les fonctions $x \\longmapsto K e^{- 3x} + \\dfrac73$.<br>
    En particulier la fonction $f$ solution telle que $f(0) = 1 \\iff K + \\dfrac73 = 1 \\iff K = - \\dfrac43$.<br>
    La seule solution est donc la fonction définie par $f(x) = - \\dfrac43 e^{-3x} + \\dfrac73$ <br>`
