    ...
    case 2: // expressions de niveau 1 (2 opérations)
      ...
      switch (souscas) {
        ...
        case 1: // a(b-c)
          ...
          break
        case 2: // a/(b+c)
          a = calculANePlusJamaisUtiliser(a * (val1 + c)) // on s'assure que le quotient tombe juste...
          ...
          break
        case 3: // a/(b-c)
          if (b <= val1) b = calculANePlusJamaisUtiliser(b + val1) // b-c positif
          a = calculANePlusJamaisUtiliser(a * (b - val1)) // on s'assure que le quotient tombe juste
          ...
          break
        case 4: // (a+b)/c
          a = calculANePlusJamaisUtiliser(a * val1)
          b = calculANePlusJamaisUtiliser(b * val1) // on s'assure que le quotient tombe juste
          ...
          break
        case 5: // (a-b)/c
          a = calculANePlusJamaisUtiliser(a * c) + val1 // on s'assure que le quotient tombe juste et que a-b>0
        ...
        case 6: // a + bc
          ...
          break
        case 7: // a - bc
          a = calculANePlusJamaisUtiliser(a + b * val1)
          ...
          break
        case 8: // a + b/c
          b = calculANePlusJamaisUtiliser(b * val1)
    ...
    case 3: // expressions de niveau 2 (3 opérations)
      ...
      switch (souscas) {
        ...
        case 4: // (a+b)/(c+d)
          d = val2
          b = val1
          if (!estentier((a + b) / (c + d))) a = calculANePlusJamaisUtiliser(a * (c + d) - b)
        ...
        case 5: // (a-b)/(c+d)
          d = val1
          b = val2
          if (a - b <= 0 || !estentier((a - b) / (c + d))) a = calculANePlusJamaisUtiliser(a * (c + d) + b)
        ...
        case 6: // (a+b)/(c-d)
          ...
          if (!estentier((a + b) / (c - d))) {
            if (a * (c - d) > b) a = calculANePlusJamaisUtiliser(a * (c - d) - b)
            else a = calculANePlusJamaisUtiliser((a + b) * (c - d) - b)
          }
        ...
        case 9: // ab-cd
          ...
          while (a * b < d * c) a = calculANePlusJamaisUtiliser(a + c)
        ...
        case 10: // ab+c/d
          d = val1
          b = val2
          if (!estentier(c / d)) c = calculANePlusJamaisUtiliser(c * d)
        ...
        case 12: // a/b+c/d
          d = val1
          b = val2
          if (!estentier(a / b)) a = calculANePlusJamaisUtiliser(a * b)
          if (!estentier(c / d)) c = calculANePlusJamaisUtiliser(c * d)
    ...
    case 5: // expressions complexes
      ...
      switch (souscas) {
        ...
        case 1: // 3(a+b)/c
          b = val1
          c = val2
          if (!estentier(3 * (a + b) / c)) a = calculANePlusJamaisUtiliser(a * c - b)
          while (a < b) a = calculANePlusJamaisUtiliser(a * c - b)
        ...
        case 2: // (a-b)/3
          nbval = 1
          b = val1
          if (!estentier((a - b) / 3)) a = calculANePlusJamaisUtiliser(3 * a + b)
    ...
    case 4: // 4 opérations
      ...
      switch (souscas) {
        case 1: // (a+b)/(c(d+e))
          b = val1
          e = val2
          if (!estentier((a + b) / (c * (d + e)))) a = calculANePlusJamaisUtiliser(a * c * (d + e) - b)
        ...
        case 3: // ab+cd/e
          d = val2
          b = val1
          if (!estentier(c * d / e)) c = calculANePlusJamaisUtiliser(c * e)
