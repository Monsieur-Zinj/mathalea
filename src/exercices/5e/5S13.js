...
import { listeQuestionsToContenu, randint, choice, arrondi, texNombre, calcul, tirerLesDes, listeDeNotes, joursParMois, unMoisDeTemperature, nomDuMois } from '../../modules/outils.js'
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, temperatures, nombreTemperatures, nombreNotes, notes, reponse, nombreDes, nombreFaces, nombreTirages, indexValeur, frequence, tirages, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      if (this.sup === 1) { // ici on lance des dés
        ...
        texteCorr += `Donc la fréquence de la note $${notes[indexValeur]}$ est : ` + `$${deprecatedTexFraction(texNombre(frequence), texNombre(nombreNotes))}$`
