...
export default function EvolutionsEnPourcentage () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
          ...
          switch (listeTypeDeQuestions[i]) {
            ...
            case 'evolution':
              if (taux > 0) {
                ...
                texteCorr += `<br>Le prix a été multiplié par $${coeff}$, il a donc diminué de $${miseEnEvidence(abs(taux))}~\\%$.`
              }
              reponse = abs(taux)
              texteApres = ' %'
              break
          ...
          switch (listeTypeDeQuestions[i]) {
            case 'finale':
              if (taux > 0) {
                ...
                texteCorr += `<br>Il y a maintenant $${miseEnEvidence(texNombre(arrive))}$ élèves dans ce ${etablissement}.`
              } else {
            ...
            case 'evolution':
              ...
              if (taux > 0) {
                ...
                texteCorr += `<br>Le nombre d'élèves a été multiplié par $${coeff}$, il a donc augmenté de $${miseEnEvidence(taux)}~\\%$.`
              } else {
                ...
                texteCorr += `<br>Le nombre d'élèves a été multiplié par $${coeff}$, il a donc diminué de $${miseEnEvidence(abs(taux))}~\\%$.`
              }
              reponse = abs(taux)
              texteApres = ' %'
              break
          ...
          switch (listeTypeDeQuestions[i]) {
            case 'finale':
              if (taux > 0) {
                ...
                texteCorr = `Une augmentation de $${taux}~\\%$ revient à multiplier par $100~\\% + ${taux}~\\% = ${100 + taux}~\\% = ${coeff}$.`
                texteCorr += `<br>$${texPrix(depart)}\\times ${coeff} = ${texPrix(arrive)}$`
                texteCorr += `<br>Le prix de ${facture} est maintenant de $${miseEnEvidence(texPrix(arrive))}$ €.`
              } else {
            ...
            case 'initiale':
              if (taux > 0) {
                ...
                texteCorr = `Une augmentation de $${taux}~\\%$ revient à multiplier par $100~\\% + ${taux}~\\%=${100 + taux}~\\% = ${coeff}$.<br>Pour retrouver le prix initial, on va donc diviser le prix final par $${coeff}$.`
                texteCorr += `<br>$${texPrix(arrive)}\\div${coeff} = ${texPrix(depart)}$`
                texteCorr += `<br>Avant l'augmentation le prix de ${facture} était de $${miseEnEvidence(texPrix(depart))}$ €.`
              } else {
                texte = `Après une diminution de $${abs(taux)}~\\%$ ${facture} coûte maintenant $${texPrix(arrive)}$ €. Calculer son prix avant la diminution.`
                texteCorr = `Une diminution de $${abs(taux)}~\\%$ revient à multiplier par $100~\\% ${taux}~\\% = ${100 + taux}~\\% = ${coeff}$.<br>Pour retrouver le prix initial, on va donc diviser le prix final par $${coeff}$.`
                texteCorr += `<br>$${texPrix(arrive)}\\div ${coeff} = ${texPrix(depart)}$`
                texteCorr += `<br>Avant la diminution, le prix de ${facture} était de $${miseEnEvidence(texPrix(depart))}$ €.`
                reponse = depart
              }
              reponse = depart
              texteApres = ' €'
          ...
          switch (listeTypeDeQuestions[i]) {
            case 'finale':
              if (taux > 0) {
                ...
                texteCorr = `Une augmentation de $${taux}~\\%$ revient à multiplier par $100~\\% + ${taux}~\\% = ${100 + taux}~\\% = ${coeff}$.`
                texteCorr += `<br>$${texNombre(depart)}\\times ${coeff} = ${texNombre(arrive)}$`
                texteCorr += `<br>La population de cette ville est maintenant de $${miseEnEvidence(texNombre(arrive))}$ habitants.`
              } else {
            ...
            case 'initiale':
              if (taux > 0) {
                ...
                texteCorr += `<br>$${texNombre(arrive)}\\div ${coeff} = ${texNombre(depart)}$`
                texteCorr += `<br>Il y a $${texNombre(nb)}$ ans cette ville comptait $${miseEnEvidence(texNombre(depart))}$ habitants.`
              } else {
      ...
      texte += ajouteChampTexteMathLive(this, i, 'inline largeur01', { texteApres })
