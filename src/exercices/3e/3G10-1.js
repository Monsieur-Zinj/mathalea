...
export default function TransformationsDuPlanEtCoordonnees () {
  ...
  this.nouvelleVersion = function () {
    ...
    const typesDeQuestionsDisponibles = gestionnaireFormulaireTexte({ saisie: this.sup, min: 1, max: 6, melange: 7, defaut: 7, nbQuestions: this.nbQuestions * 3 }).map((nb) => nb - 1)
