  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0; i < this.nbQuestions;) {
      ...
      if (choix === 1) {
        ...
        texte += ajouteChampTexteMathLive(this, indexInteractif, 'largeur5 inline', { texte: `Le ou les antécédents de $${fx1}$ (séparer les nombres avec un point-virgule) :` })
        texte += ajouteChampTexteMathLive(this, indexInteractif + 1, 'largeur5 inline', { texte: `<br>Le ou les antécédents de $${fx2}$ (séparer les nombres avec un point-virgule) :` })
        ...
        if (randint(1, 4) < 2) { // une fois sur 4 il n'y a qu'un seul antécédent
          ...
          texte += ajouteChampTexteMathLive(this, indexInteractif, 'largeur5 inline', { texte: `Le ou les antécédents de ${fx0} (séparer les nombres avec un point-virgule) :` })
