...
export default function DecompositionFacteursPremiers () {
  ...
  this.nouvelleVersion = function (numeroExercice) {
    ...
    for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      texte += ajouteChampTexteMathLive(this, i, 'largeur20 inline', { texteAvant: `<br> <b>Écrire les facteurs premiers dans l'ordre croissant et la décomposition à l'aide de puissances lorsque l'exposant est supérieur ou égal à deux.</b> <br> La décomposition de $${texNombre(nombre)}$ est : ` })
      if (context.isAmc) {
