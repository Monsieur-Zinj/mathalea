...
import { calculCompare, equalFractionCompare, expressionDeveloppeeEtReduiteCompare, intervalsCompare, scientificCompare } from '../../../lib/interactif/comparisonFunctions'
...
export default class nomExercice extends Exercice {
  ...
  nouvelleVersion () {
    ...
    i = 7
    this.listeQuestions[i] = 'Médiane de la série :<br>$15\\;;\\;2\\;;\\;12\\;;\\;10\\;;\\;7$<br>' + ajouteChampTexteMathLive(this, i)
    ...
    i = 10
    this.listeQuestions[i] = 'Si je parcours $1{,}5~\\text{km}$ en $10~\\text{min}$, quelle est ma vitesse moyenne en $\\text{km/h}$ ?<br>' + ajouteChampTexteMathLive(this, i)
    ...
    if (this.interactif) {
      this.listeQuestions[i] += ajouteChampTexteMathLive(this, i) + ' cm'
    }
    ...
    i = 15
    this.listeQuestions[i] = 'Soient $A(5\\;;\\;9)$ et $B(7\\;;\\;3)$ dans un repère orthonormé.<br>Déterminer les coordonnées du vecteur $\\overrightarrow{AB}$.<br>' + ajouteChampTexteMathLive(this, i)
    ...
    i = 16
    this.listeQuestions[i] = 'Soient $A(5\\;;\\;9)$ et $B(7\\;;\\;3)$ dans un repère orthonormé.<br>Déterminer la longueur $AB$.<br>' + ajouteChampTexteMathLive(this, i)
    ...
    i = 17
    this.listeQuestions[i] = 'Écriture scientifique de $0{,}0314$' + ajouteChampTexteMathLive(this, i)
    ...
    if (this.interactif) {
      ...
      this.listeQuestions[i] += remplisLesBlancs(this, i, 'S=\\{%{champ1} \\;;\\; %{champ2}\\}\\text{.}')
    }
    ...
    i = 19
    this.listeQuestions[i] = 'Valeur de $5x - 8$ pour $x=\\dfrac{4}{5}$<br>' + ajouteChampTexteMathLive(this, i)
    ...
    this.listeQuestions[i] = '<br>' + mathalea2d({
      ...
      scale: 0.5,
      style: 'margin: auto'
    }, objets) + '<br>Longueur de la ligne brisée en unités de longueur (u.l) :<br>' + ajouteChampTexteMathLive(this, i)
    // @ts-expect-error problème de typage pour reponse
    ...
    this.listeQuestions[i] += ajouteChampTexteMathLive(this, i)
    ...
    i = 23
    this.listeQuestions[i] = 'Soient $A(4\\;;\\;9)$ et $B(2\\;;\\;4)$.<br>Déterminer le coefficient directeur de la droite $(AB)$.<br>' + ajouteChampTexteMathLive(this, i)
    ...
    if (this.interactif) {
      this.listeQuestions[i] += remplisLesBlancs(this, i, 'M\\Big(\\{%{champ1} \\;;\\; %{champ2}\\Big)\\text{.}')
    }
