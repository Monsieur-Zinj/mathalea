...
export default function AbscisseDroiteEntiers () {
  ...
  this.nouvelleVersion = function () {
    ...
    if (choix1 === 'a') { // graduation de 200 en 200
      ...
      this.question = 'Déterminer l\'abscisse du point $A$. <br>' + mathalea2d({ xmin: -0.9, ymin: -1.5, xmax: 10, ymax: 1.2, pixelsParCm: 35, scale: 0.7 }, texteParPosition('A', 4 * x1, 0.8, 'milieu', 'blue', 2), d)
    ...
    if (choix1 === 'b') { // graduation de 250 en 250
      ...
      this.reponse = new Decimal(x1).mul(1000).add(abs0)
      this.question = 'Déterminer l\'abscisse du point $A$. <br>' + mathalea2d({ xmin: -0.9, ymin: -1.5, xmax: 10, ymax: 1.5, pixelsParCm: 30, scale: 0.7 }, texteParPosition('A', 4 * x1, 0.8, 'milieu', 'blue', 2), d)
    ...
    if (choix1 === 'g') { // graduation de 0,2 en 0,2
      ...
      this.question = 'Déterminer l\'abscisse du point $A$. <br>' + mathalea2d({ xmin: -1, ymin: -1.5, xmax: 10, ymax: 1.5, pixelsParCm: 30, scale: 0.7 }, texteParPosition('A', 4 * x1, 0.8, 'milieu', 'blue', 2), d)
      this.correction = `Entre $${texNombre(abs0)}$ et $${texNombre(abs1)}$, il y a $5$ intervalles.<br>
