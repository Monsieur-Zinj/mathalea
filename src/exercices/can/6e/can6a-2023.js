...
export default function SujetCAN2023Sixieme () {
  ...
  this.nouvelleVersion = function () {
    ...
    for (let i = 0, index = 0, nbChamps, texte, texteCorr, reponse, prenom1, prenom2, m, prix, pol, pol2, L, l, l2, E, F, G, H, maListe, taille1, res, chiffre, chiffre2, propositions, choix, a, b, c, d, e, f, k, s1, s2, s3, s4, s5, A, B, C, D, xmin, xmax, ymin, ymax, objets, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      switch (typeQuestionsDisponibles[i]) {
        ...
        case 3:
          ...
          d = []
          for (let n = 0; n < b; n++) {
            d.push(plot(n % k, -Math.floor(n / k), {
              rayon: 0.2,
              couleur: 'black',
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01')
          }
          this.listeCanEnonces.push(texte)
        ...
        case 6:
          ...
          if (this.interactif) {
            ...
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'largeur01 inline')
          }
        ...
        case 7:
          ...
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'clavierHms inline nospacebefore')
          }
        ...
        case 8:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: ' boîtes' })
          }
        ...
        case 9:
          ...
          if (this.interactif) {
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01 unites[Longueur]')
          }
        ...
        case 11:
          ...
          if (choice([true, false])) {
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: sp(1) + 'billes.' })
            }
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, index, 'largeur01 inline nospacebefore', { texteApres: sp(1) + 'ans.' })
            } else {
              texte += '$\\ldots$ ans'
            }
        ...
        case 13:
          ...
          reponse = a
          texte = 'Quel est le nombre sous le point d\'interrogation ?<br>' + mathalea2d({
            xmin: -1,
            ymin: -1.5,
            xmax: 15,
            ymax: 1.5,
        ...
        case 14:
          ...
          this.listeCanReponsesACompleter.push(`$${texNombre(b, 1)}+\\ldots =${res}$`)
          nbChamps = 1
        ...
        case 15:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ' est égal à ' + ajouteChampTexteMathLive(this, index, 'inline largeur01 nospacebefore')
          }
        ...
        case 18:
          ...
          $${texNombre(b, 0)}$ pièces a une hauteur de `
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'mm.' })
            } else {
              texte += ' $\\ldots$ mm.'
            }
            this.listeCanEnonces.push(`Si une pile de $${a}$ pièces de monnaie a une hauteur de $${2 * a}$ mm, `)
            this.listeCanReponsesACompleter.push(`alors une pile de $${texNombre(b, 0)}$ pièces a une hauteur de $\\ldots$ mm.`)
          } else {
            a = randint(2, 6)
            k = randint(2, 4)
            b = k * a
        ...
        case 19:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'fractionEgale' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'u.l.' })
          }
       ...
       En $${b}$ minutes, elle parcourt $${a}$ fois moins de km qu'en $1$ heure, soit $\\dfrac{${c}}{${a}}=
        ${miseEnEvidence(texNombre(c / a, 0))}$ km.`
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'km' })
          }

          this.listeCanEnonces.push(`Une voiture roule à $${c}$ km/h.`)
          this.listeCanReponsesACompleter.push(`Elle parcourt $\\ldots$ km en $${b}$ min à cette vitesse.`)
          nbChamps = 1
       ...
       En $${b * e}$ min, elle parcourt $${texNombre(e * c / a, 0)}$ km.<br>
        ...
        case 24:
          if (choice([true, false])) {
            ...
            this.listeCanEnonces.push('Complète.')
            this.listeCanReponsesACompleter.push(`$${a}$ centaines et $\\ldots$ dixièmes font $${texNombre(c, 1)}$.`)
          } else {
            a = randint(2, 9)
            ...
            this.listeCanEnonces.push('Complète.')
            this.listeCanReponsesACompleter.push(`$${a}$ dizaines et $\\ldots$ centièmes font $${texNombre(c, 1)}$.`)
          }
        ...
        `
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'petits carreaux.' })
          }
          ...
          this.listeCanReponsesACompleter.push('La figure doit contenir $\\ldots$ petits carreaux.')
          nbChamps = 1
          break
        ...
        case 26:
          if (choice([true, false])) {
            ...
            texte += mathalea2d({
              ...
              scale: 0.6,
              style: 'margin: auto'
            }, texteParPosition('?', 3 * a / 5, 0.9, 'milieu', 'blue', context.isHtml ? 2 : 1.5), droiteGraduee({
              Unite: 3,
              Min: 0,
              Max: 3.2,
              x: 0,
        ...
        case 27:
          if (choice([true, false])) {
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'centimes' })
            }
          }
          this.listeCanEnonces.push(texte)
        ...
        case 30:
          ...
          if (this.interactif) {
            texte += '<br>' + ajouteChampTexteMathLive(this, index, 'inline largeur01', { texteApres: 'repas' })
          } else {
            texte += ''
          }
          nbChamps = 1
