import { calcul, choice, randint, texNombre, texNombre, texteEnCouleur } from '../../../modules/outils.js'
...
export default function MultiplierAstucieusement () {
  ...
  this.nouvelleVersion = function () {
    ...
    switch (choice([1, 2, 3, 4])) {
      case 1:
        ...
        this.correction = `$4 \\times ${texNombre(d)}\\times 25 = 100 \\times ${texNombre(d)} = ${texNombre(100 * d)}$`
  ...
  on obtient ainsi comme résultat : $${texNombre(100 * d)}$.
    `)
        break
      case 2:
        this.question = `Calculer $2 \\times ${texNombre(d)}\\times 50$.`
        this.correction = `$2 \\times ${texNombre(d)}\\times 50 = 100 \\times ${texNombre(d)} = ${texNombre(100 * d)}$`
        this.correction += texteEnCouleur(`<br> Mentalement : <br>
  ...
  on obtient ainsi comme résultat : $${texNombre(100 * d)}$.
    `)
      ...
      case 3:
        ...
        this.correction = `$25 \\times ${texNombre(d)}\\times 4 = 100 \\times ${texNombre(d)} = ${texNombre(100 * d)}$`
        this.correction += texteEnCouleur(`<br> Mentalement : <br>
      ...
      case 4:
        ...
        this.correction = `$50 \\times ${texNombre(d)}\\times 2 = 100 \\times ${texNombre(d)} = ${texNombre(100 * d)}$`
        this.correction += texteEnCouleur(`<br> Mentalement : <br>
