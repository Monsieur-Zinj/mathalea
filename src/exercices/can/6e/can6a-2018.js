    ...
    for (let i = 0, index = 0, nbChamps, texte, texteCorr, reponse, fraction1 = [], propositions, choix, truc, chiffre, chiffre2, a, b, c, d, m, n, k, j, A, B, C, D, E, F, G, H, pol, n1, d1, pol2, l, L, l2, prenom1, xmin, xmax, ymin, ymax, objets, fleurs, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      switch (typeQuestionsDisponibles[i]) {
        ...
        case 9 :
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += `$${a * k}$ ${truc} pèsent ` + ajouteChampTexteMathLive(this, index, 'nospacebefore inline largeur01') + ' g'
          } else {
        ...
        case 13 :
          ...
          texteParPosition('A', 3 * a / 5, 0.7, 'milieu', 'blue', context.isHtml ? 2 : 1), droiteGraduee({
            Unite: 3,
            Min: 0,
            Max: 3.2,
            x: 0,
        ...
        case 18 :
          ...
          objets.push(texteParPosition(`${stringNombre(j)} cm`, milieu(D, C).x, milieu(D, C).y + 0.5),
            texteParPosition(`${stringNombre(1.5)} cm`, milieu(D, A).x - 1.1, milieu(D, A).y),
            segment(0, 0.5, j, 0.5)
          )
        ...
        case 20 :
          ...
          a = Math.floor(n1 / d1)
          reponse = `${a};${a + 1}`
          texte = 'Encadre la fraction par deux entiers consécutifs : '
        ...
        case 21 :
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'nospacebefore inline largeur01') + ' œufs.'
          } else {
            texte += ' ....  œufs.'
          }
        ...
        case 22 :
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'nospacebefore inline largeur01') + ' g.'
          } else {
            texte += ' ....  g.'
          }
