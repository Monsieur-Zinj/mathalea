     ...
     ${texNombre(a * 10000)} + ${texNombre(b * 100)} + ${texNombre(c * 10)}=${texNombre(reponse)}$`
      ...
      ${texNombre(c * 10000)}+ ${texNombre(b * 1000)} + ${texNombre(a * 10)} =${texNombre(reponse)}$`
        ...
        case 16:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'nospacebefore inline largeur01') + '$\\pi$cm$^3$'
          }
          nbChamps = 1
          break
        ...
        case 19:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'nospacebefore inline largeur01') + 'dm'
          } else {
            texte += ' $\\ldots$ dm '
          }
          nbChamps = 1
