...
import { afficheCoteSegment, codageSegments, point, polygoneRegulier, segment, texteSurSegment } from '../../../modules/2d.js'
    ...
    for (let i = 0, texte, texteCorr, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (typeQuestionsDisponibles[listeIndex[i]]) { // Suivant le type de question, le contenu sera différent
        ...
        case 'q28':
          ...
          texteCorr = `Le film a duré $${calcul(c / 60 >> 0)}$ h $${c % 60}$ min soit $${c}$ minutes.`
          setReponse(this, i, c, { formatInteractif: 'calcul' })
          break
