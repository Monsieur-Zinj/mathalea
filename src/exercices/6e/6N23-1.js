      ...
      switch (typesDeQuestions) {
        case 1: // n/100 = .... + .../10 + .../100=...
          ...
          if (this.interactif && !context.isAmc) {
            texte = `$${fraction(n, '100')}=$` + ajouteChampTexteMathLive(this, indexQ, 'largeur10 inline nospacebefore')
            ...
            setReponse(this, indexQ, arrondi(u + d / 10 + c / 100, 2), { formatInteractif: 'calcul' })
            indexQ++
          } else {
        ...
        case 6: // n/10 = ... + .../10 + .../100 = ...
          ...
          if (this.interactif && !context.isAmc) {
            ...
            indexQ++
            texte += '$=$' + ajouteChampTexteMathLive(this, indexQ, 'largeur10 inline nospacebefore')
            setReponse(this, indexQ, arrondi(n / 10, 1), { formatInteractif: 'calcul' })
            indexQ++
          } else {
