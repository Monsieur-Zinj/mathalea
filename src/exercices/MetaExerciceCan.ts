...
export default class MetaExercice extends Exercice {
  ...
  En choisissant un nombre de questions (inférieur ou égal à 30), on fabrique une « mini » course aux nombres qui respecte la proportion de nombre de questions élémentaires par rapport aux autres.
