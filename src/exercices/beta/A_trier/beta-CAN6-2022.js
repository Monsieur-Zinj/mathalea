    ...
    for (let i = 0, index = 0, nbChamps, texte, texteCorr, reponse, maListe, taille1, chiffre, chiffre2, propositions, code1, code2, code3, code4, choix, a, b, c, d, k, s1, s2, A, B, C, D, xmin, xmax, ymin, ymax, objets, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      switch (typeQuestionsDisponibles[i]) {
        ...
        case 8:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'groupes'
          } else {
            texte += '$\\ldots$ groupes.'
          }
          nbChamps = 1
        ...
        case 13:
          if (choice([true, false])) {
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'quarts'
            } else {
              texte += '$\\ldots$ quarts'
            }
          } else {
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'tiers'
            } else {
              texte += '$\\ldots$ tiers'
            }
          }
...
$${a + 1}$ h et $${reponse}$ min.`
        ...
        case 16:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'billes'
          } else {
            texte += '$\\ldots$ billes.'
          }
          nbChamps = 1
    ...
    Ainsi pour passer des "g" au "kg", on divise par $${texNombre(1000)}$.<br>
      Comme : $${texNombre(a)}\\div ${texNombre(1000)} =${texNombre(a / 1000)}$, alors $${texNombre(a)}$ g$=${texNombre(a / 1000)}$ kg.  `
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'kg'
            } else {
              texte += '  $\\ldots$ kg'
            }
          } else {
            ...
            setReponse(this, index, reponse, { formatInteractif: 'calcul' })
            if (this.interactif) {
              texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'g'
            } else {
              texte += '  $\\ldots$ g'
            }
          }
        ...
        case 20:
          ...
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'unité'
          } else {
        ...
        case 21:
          ...
          setReponse(this, index, reponse, { formatInteractif: 'calcul' })
          if (this.interactif) {
            texte += ajouteChampTexteMathLive(this, index, 'inline largeur01') + 'h'
          } else {
            texte += '$\\ldots$ h'
          }
