...
une homothétie de centre O. Quel est son rapport?`
    ...
    this.correction = 'Les deux figures sont de part et d\'autres de $O$, donc le rapport est négatif.<br>De plus, DEF est plus grand que ABC donc le rapport n\'est pas compris entre -1 et 1.<br>Le rapport est donc $-2$.'
  }
}
