    ...
    for (let i = 0, a, b, d, a2, a3, b2, b3, d2, d3, c, c2, c3, a4, b4, c4, d4, a4Frac, a5, b5, c5, d5, a5Frac, a6, b6, c6, d6, a6Frac, r, t1, t2, t3, s1, s2, s3, s4, s5, s6, aFrac, a2Frac, a3Frac, pente1, pente2, pente3, pente4, pente5, pente6, texte, texteCorr, lsys, ss1, ss2, ss3, vari, lass, cpt = 0;
      ...
      if (this.correctionDetaillee) {
        ...
        if (!([b3, b4, b5, b6].includes(b))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la première droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '1')]} est ${b} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '1')]} est associé au premier graphique.<br>`
        } else if (!([b3, b4, b5, b6].includes(b2))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la deuxième droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '1')]} est ${b2} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '1')]} est associé au graphique premier graphique.`
        } else if (!([b, b2, b5, b6].includes(b3))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la première droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '2')]} est ${b3} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '2')]} est associé au deuxième graphique.`
        } else if (!([b, b2, b5, b6].includes(b4))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la deuxième droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '2')]} est ${b4} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '2')]} est associé au deuxième graphique.`
        } else if (!([b, b2, b3, b4].includes(b5))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la première droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '3')]} est ${b5} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '3')]} est associé au troisième graphique.`
        } else if (!([b, b2, b3, b4].includes(b6))) {
          texteCorr = texteCorr + `L'ordonée à l'origine de la deuxième droite dans le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '3')]} est ${b6} et aucune droite dans un autre système n'a la même ordonnée à l'origine. Ainsi le système ${['$A$', '$B$', '$C$'][lass.findIndex(item => item === '3')]} est associé au troisième graphique.`
        }
