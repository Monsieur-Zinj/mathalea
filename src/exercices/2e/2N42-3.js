...
import { listeQuestionsToContenu, randint, numAlpha, rienSi1, ecritureAlgebrique, sp } from '../../modules/outils.js'
...
export const dateDePublication = '22/06/2023'
...
export default class EtudeTrinome extends Exercice {
  ...
  nouvelleVersion () {
    let a = randint(-4, 4, [0, 1]), question1, question2, question3
    if (this.sup2 === 1){a=1}
 ...
 \\end{aligned}$`
    ...
    $(${p.x1.simplifie().texFraction}\\, ;\\,0)$ et $(${p.x2.simplifie().texFraction}\\,;\\,0)$`
      ...
      let q3c
        ...
        q3c = `Résoudre l'équation $f(x)=${p.beta.simplifie().texFraction}$.`
