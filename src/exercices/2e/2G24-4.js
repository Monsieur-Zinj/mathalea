...
export default function Calculercoordonneesproduitvecteurs () {
  ...
  this.nouvelleVersion = function () {
    ...
    if (this.sup === 1) {
      typesDeQuestionsDisponibles = [1] // On donne 1 vecteur à coordonnées entières et un entier
    }
    if (this.sup === 2) {
      typesDeQuestionsDisponibles = [2] // On donne 1 vecteur à coordonnées fractionnaires et une fraction
    }
    if (this.sup === 3) {
      typesDeQuestionsDisponibles = [3] // On donne 2 points à coordonnées entières et un entier
    }
