...
export function verifQuestionMathLive (exercice, i, writeResult = true) {
  ...
  if (exercice.autoCorrection[i].reponse == null){
    window.notify(`verifQuestionMathlive appelé sur une question sans réponse`,{exercice, question: i, autoCorrection: exercice.autoCorrection[i]})
  } else {
    if (exercice.autoCorrection[i].reponse.param == null) {
      window.notify(`verifQuestionMathlive appelé sur une question sans param`,{exercice, question: i, param: exercice.autoCorrection[i].reponse})
    } else {
